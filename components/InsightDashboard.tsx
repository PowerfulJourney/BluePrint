...
const InsightDashboard: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Main Drawer Panel */}
      <div 
          className={`h-full bg-white border-l border-gray-200 shadow-xl z-20 transition-all duration-300 ease-out relative flex flex-col ${isOpen ? 'w-80 translate-x-0' : 'w-0 translate-x-10 opacity-0 overflow-hidden'}`}
      >
        {/* Header */}
        <div className="p-5 border-b border-gray-100 flex-shrink-0 flex justify-between items-center min-w-[320px]">
          <div>
          ...
          <button 
            ...
            className="flex-shrink-0 text-gray-400 hover:text-gray-700 hover:bg-gray-100 p-2 rounded transition-colors"
            title="收起面板"
          >
